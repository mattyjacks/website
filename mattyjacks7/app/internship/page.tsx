  ...
  return (
    <main className="min-h-screen flex flex-col pt-24 pb-20">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div ref={headerRef} className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight mb-6">
              MattyJacks <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-sky-400">Internship</span> Opportunity
            </h1>
      ...
      <section className="px-4 py-20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-sm uppercase tracking-[0.2em] text-emerald-700 dark:text-emerald-300 mb-2">The <span className="font-bold text-blue-600 dark:text-sky-500">Program</span></p>
          ...
          <div ref={programRef} className="grid md:grid-cols-3 gap-8">
            ...
            <div className="group rounded-2xl border border-zinc-200 dark:border-zinc-800 p-8 bg-white dark:bg-zinc-950 hover:border-sky-400 dark:hover:border-sky-500 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              <div className="w-14 h-14 rounded-xl bg-sky-100 dark:bg-blue-900/30 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <Briefcase className="w-7 h-7 text-blue-600 dark:text-sky-400" />
              </div>
      ...
      <section className="px-4 py-20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-sm uppercase tracking-[0.2em] text-emerald-700 dark:text-emerald-300 mb-2">Vibe <span className="font-bold text-blue-600 dark:text-sky-500">Coded</span> Examples</p>
